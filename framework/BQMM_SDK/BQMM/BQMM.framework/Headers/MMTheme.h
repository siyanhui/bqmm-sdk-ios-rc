 ...
 *  表情包详情页禁止下载文字背景颜色
 */
@property (nonatomic, strong) UIColor  *detailPackageBannedBgColor;
/**
 *  表情包详情页禁止下载文字字体
 */
@property (nonatomic, strong) UIFont   *detailPackageBannedFont;

/**
 *  表情包详情页禁止下载文字颜色
 */
@property (nonatomic, strong) UIColor  *detailPackageBannedColor;
 ...
 *  表情包禁止下载的提示背景颜色
 */
@property (nonatomic, strong) UIColor *packageBannedBgColor;
/**
 *  表情包禁止下载的提示文字颜色
 */
@property (nonatomic, strong) UIColor *packageBannedTextColor;
/**
 *  表情包禁止下载的提示文字字体
 */
@property (nonatomic, strong) UIFont   *packageBannedTextFont;
